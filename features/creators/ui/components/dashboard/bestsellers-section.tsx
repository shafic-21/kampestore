...
const mockProducts: Product[] = [
  ...
  },
  {
    ...
    category: 'Apparel',
    specifications: ['50/50 Cotton-Poly blend', 'Double-lined hood', 'Pouch pocket', 'Air-jet spun yarn'],
    isBestseller: true
  },
  {
    id: '3',
    ...
    specifications: ['Premium matte finish', '1.25" depth', 'Gallery wrapped', 'Ready to hang'],
    isBestseller: true
  },
  {
    id: '4',
    ...
    specifications: ['Impact resistant', 'Wireless charging compatible', 'Precise cutouts', 'Hybrid construction'],
    isBestseller: true
  }
];

export function BestsellersSection({ products = mockProducts }: BestsellersSectionProps) {
  return (
    <div className="mb-8">
