...
export function RegisterForm() {
	...
	const { error: emailError, isValidating: emailValidating } =
	...
	const { error: phoneError, isValidating: phoneValidating } =
		useDebouncedValidation(phone, phoneSchema, 300);

	const { error: fullNameError, isValidating: fullNameValidating } =
		useDebouncedValidation(fullName, fullNameSchema, 300);
