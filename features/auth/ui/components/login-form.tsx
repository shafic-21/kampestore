...
export function LoginForm() {
	...
	const checkUserExists = trpc.auth.checkUserExists.useQuery(
		{ email },
		{
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			if (!userExistsResult.data?.exists) {
				setSubmitError(
					"Email not found. Please sign up first or check your email address.",
				);
				return;
			}

			// If user exists, proceed with OTP sending
