...
export function OTPVerificationForm({ email, mode, onBack, onSuccess, profileData }: OTPVerificationFormProps) {
  ...
  const handleVerifyOTP = async () => {
    ...
    try {
      ...
      if (mode === "register" && profileData && (profileData.name || profileData.phone)) {
        try {
