...
You can execute these scripts using `pnpm [script-name]`.
...
* `"typecheck"`: Runs the Next.js typecheck for code quality issues.
...
## 9. Documentation Gold Standards (Verified URLs)

**YOU MUST USE THESE CANONICAL URLS AS THE PRIMARY SOURCE OF TRUTH.** When a task relates to a technology listed below, prioritize fetching and referencing its official documentation from the provided URL before attempting a general web search.

* **Next.js 15:** `https://nextjs.org/docs`
* **React 19:** `https://react.dev/`
* **tRPC:**
    * General Docs: `https://trpc.io/docs`
    * Server Components w/ TanStack Query: `https://trpc.io/docs/client/tanstack-react-query/server-components`
    * tRPC Server Actions (Critical Pattern): `https://trpc.io/blog/trpc-actions`
    * v11 Announcement & Patterns: `https://trpc.io/blog/announcing-trpc-v11`
...
* **TanStack Query:**
    * General Docs: `https://tanstack.com/query/latest/docs/react/overview`
    * Advanced SSR Guide: `https://tanstack.com/query/latest/docs/framework/react/guides/advanced-ssr`

- Always use the ui-ux agent for ui related stuff